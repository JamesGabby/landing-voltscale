      ...
      <div className="container-custom">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-grey-600 sm:text-xl md:text-2xl max-w-4xl text-pretty leading-relaxed">
            <span className="font-bold text-foreground">For Software Agencies: How to Add $1,500,000+ to Your Pipeline by Installing the CRI Protocol Without Relying on Referrals or Managing an Internal SDR Team</span>
          </p>
